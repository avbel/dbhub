 ...
 * - MySQL/MariaDB/ClickHouse: Backticks (`identifier`)
 ...
 * @param dbType - The database type (postgres, mysql, mariadb, sqlite, sqlserver, clickhouse)
...
export function quoteIdentifier(identifier: string, dbType: ConnectorType): string {
  ...
  switch (dbType) {
    ...
    case "mariadb":
    case "clickhouse":
      // MySQL, MariaDB and ClickHouse use backticks
